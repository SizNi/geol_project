...
def gis_to_pdf():
    ...
    if os.path.exists("well_passport/fixtures/gis_2.doc"):
        ...
        img_to_pdf("well_passport/fixtures/gis_2.png", "well_passport/fixtures/gis_2.pdf")
    elif os.path.exists("well_passport/fixtures/gis_2.jpg"):
        img_to_pdf("well_passport/fixtures/gis_2.jpg", "well_passport/fixtures/gis_2.pdf")
    elif os.path.exists("well_passport/fixtures/gis_2.bmp"):
        bmp_to_png("well_passport/fixtures/gis_2.bmp", "well_passport/fixtures/gis_2.png")
        img_to_pdf("well_passport/fixtures/gis_2.pdf", "well_passport/fixtures/gis_2.png")
        os.remove("well_passport/fixtures/gis_2.png")
    if os.path.exists("well_passport/fixtures/gis_2.pdf") and os.path.exists("well_passport/fixtures/gis.pdf"):
        pdf_list = ["well_passport/fixtures/gis.pdf", "well_passport/fixtures/gis_2.pdf"]
